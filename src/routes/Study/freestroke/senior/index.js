...
class EditableTable extends React.Component {
  ...
  delete(form, key){
   ...
   axios.post('http://localhost:4000/swimmimg/skill/deleteSenior',obj)
  ...
  save(form, key) {
    form.validateFields((error, row) => {
      ...
      if (index > -1) {
        ...
        // 发起网络请求 
        axios.post('http://localhost:4000/swimmimg/skill/findsenior',newData[index])
    ...
    handleSubmit(e){
        ...
        this.props.form.validateFields((err,values)=>{ 
            if(!err){
                const {text } = values
                obj.content  = text
                axios.post('http://localhost:4000/swimmimg/skill/senior',obj)
